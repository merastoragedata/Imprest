(function() {
  ...
  function form2PrintHtml(e, cycle) {
    ...
    return '<div class="pg f2-page">' +
      ...
      settleHtml +
      '<div class="f2-sign">' + esc(d.name) + ",<br>" + esc(d.designation) + "<br>" + esc(d.office) + "</div>" +
      cycleTag +
      "</div>";
  }
  ...
  function pavatiHtmlContent(e, tx) {
    ...
    return '<div class="pav-page"><div class="pav-title">पावती</div>' +
      ...
      '<div class="pav-line"><b>पावती लिहून देणार :-</b> &nbsp;&nbsp;<span class="pav-blank">' + esc(persons.filter(Boolean).join(", ") || "&nbsp;") + "</span></div>" +
  ...
  function blankPavatiHtml() {
    return '<div class="pav-page"><div class="pav-title">पावती</div>' +
      ...
      '<div class="pav-line"><b>पावती लिहून घेणार :-</b> &nbsp;&nbsp;सहाय्यक अभियंता, 400kV R.S Karjat</div>' +
      '<div class="pav-line"><b>पावती लिहून देणार :-</b> &nbsp;&nbsp;<span class="pav-blank">&nbsp;</span></div>' +
      '<div class="pav-line">मी, खालील सही करणार असे लिहून देतो की, मला सहाय्यक अभियंता, यांचे कडून कामाचे<br>रु ________________(अक्षरी _______________________________________________ रु)<br>रोख मिळाले. कुठलीही तक्रार नाही.</div>' +
