(function() {
  ...
  function detectWeather() {
    ...
    navigator.geolocation.getCurrentPosition(function(pos) {
      ...
      fetch("https://api.open-meteo.com/v1/forecast?latitude=" + lat + "&longitude=" + lon + "&current=weather_code,is_day")
    ...
    }, function() { /* permission denied — keep the fallback scenery */ }, { timeout: 6000 });
  }
  function initAtmos() {
    buildSky();
  ...
  function atmosControlsHtml() {
    return '<div class="atmos-controls">' +
      '<select class="weather-select" id="weatherSelect" title="Weather">' +
